...
public class BloomFilterUtil {
    ...
    //获取一个布隆过滤器fileName:持久化的文件名,这里是相对路径,就在本项目下
    public static BloomFilter<String> getStringBloomFilter(String fileName){
        ...
        try {
            ...
            if (!file.exists()){
                ...
                BloomFilter<CharSequence> charSequenceBloomFilter = BloomFilter.readFrom(fileInputStream, charSequenceFunnel);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
